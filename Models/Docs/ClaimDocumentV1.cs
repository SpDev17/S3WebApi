...
public class ClaimDocumentV1 : DocumentBaseV1
{
    public ClaimDocumentV1()
    {
    }

    public ClaimDocumentV1(IDocumentInfo documentInfo) : base(documentInfo)
    {
    }
    ...
    [ListItemColumn("CarrierClaimNoLookup", Inherited = true)]
    ...
    [ListItemColumn("ClaimName")]
    public string? ClaimName { get; set; }

    [ListItemColumn("ClaimTypeLookup", Inherited = true)]
    ...
    [ListItemColumn("DateOfClaimClosed", Inherited = true)]
    ...
    [ListItemColumn("RecoveryNo", Inherited = true)]
    ...
    public static Expression<Func<ClaimDocumentV1, object>> All()
    {
        return s => new
        {
            s.AliasFlag,

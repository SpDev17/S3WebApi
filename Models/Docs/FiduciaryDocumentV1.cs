...
public class FiduciaryDocumentV1 : DocumentBaseV1
{
    public FiduciaryDocumentV1()
    {
    }

    public FiduciaryDocumentV1(IDocumentInfo documentInfo) : base(documentInfo)
    {
    }
    ...
    [ListItemColumn("PaymentAmount")]
    public string? PaymentAmount { get; set; }

    [ListItemColumn("PaymentBeneficiary")]
    public string? PaymentBeneficiary { get; set; }

    [ListItemColumn("PaymentCurrencyLookup")]
    public ManagedMetadata? PaymentCurrency { get; set; }
    ...
    [ListItemColumn("ReferenceNumber")]
    public string? ReferenceNumber { get; set; }

    // ReSharper disable once StringLiteralTypo
    // ReSharper disable once IdentifierTypo
    [ListItemColumn("RemitterName")]
    ...
    public static Expression<Func<FiduciaryDocumentV1, object>> All()
    {
        return s => new
        {
            s.AliasFlag,

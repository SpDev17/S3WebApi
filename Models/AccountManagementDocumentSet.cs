...
public class AccountManagementDocumentSet : DocumentSetBase
{
    public AccountManagementDocumentSet()
    {
    }

    public AccountManagementDocumentSet(IDocumentSetInfo documentSetInfo) : base(documentSetInfo)
    {
    }
    ...
    public override bool IsDocumentSetValid(IConfiguration configuration)
    {
        var contentTypes =
            configuration
                ...
                .GetSection(nameof(AccountManagementDocumentSet))
                .Get<List<string>>();

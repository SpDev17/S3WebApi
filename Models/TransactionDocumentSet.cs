...
public class TransactionDocumentSet : DocumentSetBase
{
    public TransactionDocumentSet()
    {
    }

    public TransactionDocumentSet(IDocumentSetInfo documentSetInfo) : base(documentSetInfo)
    {
    }
    ...
    [ListItemColumn("YearOfTransaction", IsIncludedByDefault = true)]
    ...
    public override bool IsDocumentSetValid(IConfiguration configuration)
    {
        var contentTypes =
            configuration
                ...
                .GetSection(nameof(TransactionDocumentSet))
                .Get<List<string>>();

        return
            CompanyNumber != null &&
            Country != null &&
            !string.IsNullOrWhiteSpace(YearOfTransaction) &&
            ContentType != null &&
